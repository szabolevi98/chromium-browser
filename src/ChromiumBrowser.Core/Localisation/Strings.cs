...
public static class Strings
{
    ...
    private static readonly Dictionary<string, (string English, string Hungarian)> Table = new()
    {
        ...
        ["settings.onStart"] = ("On starting", "Indításkor"),
        ["settings.restore"] = ("Open the windows and tabs that were open last time",
                                "Nyíljon meg az, ami legutóbb nyitva volt"),
        ["settings.clearSession"] = ("Forget what was open", "A legutóbb nyitva volt lapok elfelejtése"),
        ["settings.fromLastTime"] = ("from last time", "a legutóbbi alkalomból"),
        ["settings.tabOne"] = ("tab", "lap"),
        ["settings.tabMany"] = ("tabs", "lap"),
